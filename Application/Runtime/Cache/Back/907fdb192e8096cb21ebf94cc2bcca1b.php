      ...
      <td width="350" valign="top">
       <form action="<?php echo U('Back/Index/uploadimg'); ?>" method="post" enctype="multipart/form-data">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
         <tr>
          <td><b>图片名称</b>
<input type="text" name="name" value="<?php echo ($data['name']); ?>" size="20" class="inpMain" />
          </td>
         </tr>
         <tr>
          <td><b>选择图片</b>
           <input type="file" name="img" class="inpFlie" /><a href="http://www.weiqing.com/data/slide/20130514acunau.jpg" target="_blank"><img src="/Public/Admin/images/icon_yes.png"></a>          </td>
         </tr>
         
         <tr>
          <td>
         <a href="show.html" class="btnGray">取消</a>
      ...
      <td valign="top">
       <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
        ...
        <tr>
         ...
         <td align="center"><a href="<?=U('back/index/editimg',array('id'=>$val['id']));?>">编辑</a> | <a href="#">删除</a></td>
        </tr>
        <?php  } ?>
               </table>
      </td>

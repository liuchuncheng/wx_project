...
<div id="urHere">管理中心<b>></b><strong>添加商品</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
  ...
  <link rel="stylesheet" href="/Public/Back/js/kindeditor/themes/default/default.css" />
      <link rel="stylesheet" href="/Public/Back/js/kindeditor/plugins/code/prettify.css" />
      <script charset="utf-8" src="/Public/Back/js/kindeditor/kindeditor.js"></script>
      <script charset="utf-8" src="/Public/Back/js/kindeditor/lang/zh_CN.js"></script>
      <script charset="utf-8" src="/Public/Back/js/kindeditor/plugins/code/prettify.js"></script>
        <script>
          KindEditor.ready(function(K) {
            var editor1 = K.create('textarea[name="description"]', {
              cssPath : '/Public/Back/js/kindeditor/plugins/code/prettify.css',
              uploadJson : '/Public/Back/js/kindeditor/php/upload_json.php',
              fileManagerJson : '/Public/Back/js/kindeditor/php/file_manager_json.php',
        ...
        <script>
          KindEditor.ready(function(K) {
            var editor1 = K.create('textarea[name="goodnotice"]', {
              cssPath : '/Public/Back/js/kindeditor/plugins/code/prettify.css',
              uploadJson : '/Public/Back/js/kindeditorphp/upload_json.php',
              fileManagerJson : '/Public/Back/js/kindeditor/php/file_manager_json.php',
              allowFileManager : true,
              afterCreate : function() {
                var self = this;
